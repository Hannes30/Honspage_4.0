...
<nav class={"flex justify-around items-center lg:mr-4 mr-1 fixed w-full z-40 lg:p-4 py-4 rounded-md bg-opacity-50 duration-500" + (isNavbarAtTop ? "" : " bg-secondary")}>
  ...
  <div class="lg:w-1/3 w-2/3 flex justify-around">
