...
<button on:click={openContactModal} class="button bg-primary-400  rounded-md text-secondary px-10 py-4 text-3xl font-medium m-10 relative top-0 hover:-top-1 duration-300">Kontaktiere mich</button>
</div>
<style>
