...
<div
  class="flex flex-wrap justify-around items-center lg:ml-16 ml-4 lg:flex-nowrap pt-20 overflow-x-hidden sm:pt-24 relative top-[20px]"
>
  ...
  <div class="w-1/2 md:h-full relative">
    <enhanced:img
