...
const LandingScreen = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `<div class="flex flex-wrap justify-around items-center ml-16 lg:flex-nowrap pt-20"><div class="lg:pb-40" data-svelte-h="svelte-1w1t1i4"><h1>Hannes Scheibelauer</h1> <span>Der kreative Webentwickler 
        für <span class="text-secondary bg-primary-200 px-2 rounded-md backgroundFadeIn svelte-1e1rae9">deine</span> digitale Erfolgsstory!</span></div> <div class="">${
          typeof HanneswithDotsLight_medium === 'string'
            ? `<img${add_attribute('src', HanneswithDotsLight_medium.img.src, 0)} alt="Hannes Scheibelauer with Web Icons"${add_attribute('width', HanneswithDotsLight_medium.img.w, 0)}${add_attribute('height', HanneswithDotsLight_medium.img.h, 0)}> `
            : `<picture>${each(
                Object.entries(HanneswithDotsLight_medium.sources),
                ([format, srcset]) => {
                  return `<source${add_attribute('srcset', srcset, 0)}${add_attribute('type', 'image/' + format, 0)}>`
                },
              )} <img${add_attribute('src', HanneswithDotsLight_medium.img.src, 0)} alt="Hannes Scheibelauer with Web Icons"${add_attribute('width', HanneswithDotsLight_medium.img.w, 0)}${add_attribute('height', HanneswithDotsLight_medium.img.h, 0)}></picture> `
        }</div> </div>`
  },
)
const css$2 = {
...
const Blobs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="m-4 -mt-20"><div class="flex flex-wrap justify-around text-center w-full font-bold text-5xl">${validate_component(
    Blob,
    'Blob',
  ).$$render(
    $$result,
    {
      ...
      path1:
        'M57.9,-44.5C74,-26,85.3,-2,80.8,18.7C76.3,39.4,56,56.8,34.4,64.5C12.9,72.2,-10,70.2,-29.7,61C-49.4,51.7,-65.9,35.3,-71.6,15C-77.4,-5.3,-72.2,-29.4,-58.5,-47.4C-44.7,-65.3,-22.4,-77.2,-0.7,-76.6C20.9,-76,41.8,-63,57.9,-44.5Z',
    },
    {},
    {},
    ...
    $$result,
    {
      ...
      delay: 1e3,
      path2:
        'M58.6,-45.7C74.8,-26.5,85.8,-2.2,81,18.3C76.2,38.9,55.5,55.7,33.3,64.8C11,73.8,-12.9,75.1,-31.7,66C-50.6,56.9,-64.4,37.4,-69.7,15.5C-75.1,-6.4,-71.9,-30.6,-58.9,-49.1C-45.9,-67.6,-22.9,-80.3,-0.8,-79.6C21.2,-78.9,42.5,-64.9,58.6,-45.7Z',
      path1:
        'M58.6,-48.8C71.2,-31.1,73.1,-7,67.9,15.4C62.7,37.7,50.4,58.3,32,67.5C13.7,76.7,-10.6,74.6,-32.4,65C-54.3,55.4,-73.7,38.3,-80.5,16.2C-87.3,-6,-81.5,-33.2,-66,-51.6C-50.5,-70,-25.3,-79.6,-1.1,-78.7C23.1,-77.9,46.1,-66.5,58.6,-48.8Z',
    },
    {},
    {},
  )} ${validate_component(Blob, 'Blob').$$render(
    $$result,
    {
      ...
      delay: 2500,
      path2:
        'M60.1,-45.2C75.8,-28.3,84.9,-3.4,80.3,19.1C75.8,41.5,57.5,61.6,34.7,72.8C12,84,-15.4,86.4,-36.6,76.2C-57.7,65.9,-72.6,42.9,-76.7,19.2C-80.7,-4.5,-73.8,-28.9,-59.2,-45.6C-44.6,-62.3,-22.3,-71.1,0,-71.1C22.2,-71.1,44.4,-62.1,60.1,-45.2Z',
      path1:
        'M54.9,-40.7C70.4,-24.4,81.7,-1.6,79,21C76.2,43.7,59.4,66.1,36.9,77.1C14.4,88.1,-13.8,87.6,-33.7,75.8C-53.6,63.9,-65.2,40.7,-69.5,17.2C-73.8,-6.4,-70.8,-30.2,-58,-46C-45.2,-61.7,-22.6,-69.3,-1.4,-68.1C19.7,-67,39.4,-57.1,54.9,-40.7Z',
    },
    {},
    {},
  )}</div></div>`
...
const Question = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { QuestionText } = $$props
    if (
      $$props.QuestionText === void 0 &&
      $$bindings.QuestionText &&
      QuestionText !== void 0
    )
...
const Questions = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    $$result.css.add(css)
    return `<div class="bg-secondary w-full h-20 lg:rotate-2 rotate-6 relative overflow-x-hidden"></div>  <div class="-mt-10 w-full flex justify-center flex-wrap bg-secondary -mb-20 py-10 z-10 relative">${validate_component(
      Question,
      'Question',
    ).$$render(
      $$result,
      ...
      $$result,
      { QuestionText: 'Was kostet eine Website?' },
      {},
      {
        default: () => {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${(($$result.head += `<!-- HEAD_svelte-i9npbb_START -->${(($$result.title = `<title>Home - Hannes Scheibelauer</title>`), '')}<!-- HEAD_svelte-i9npbb_END -->`), '')} <div>${validate_component(Nav, 'Nav').$$render($$result, { active: '1' }, {}, {})} ${validate_component(LandingScreen, 'LandingScreen').$$render($$result, {}, {}, {})} <div class="-top-44 relative lg:-top-36">${validate_component(
    Waves,
    'Waves',
  ).$$render(
    $$result,
