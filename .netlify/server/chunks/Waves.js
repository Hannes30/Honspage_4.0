import { c as create_ssr_component, b as escape, n as null_to_empty } from "./ssr.js";
/* empty css                                    */
const waves = "/_app/immutable/assets/waves.AvBJSobg.png";
const css = {
  code: ".waves.svelte-sezhr0{background-size:100% 100%;background-position:70%}@media only screen and (min-width: 1024px){.waves.svelte-sezhr0{background-size:100% 100%}}",
  map: null
};
